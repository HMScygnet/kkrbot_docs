...
每次对话token消耗量与上下文，人格，提问的问题有关，具体参考[openai计费策略](https://openai.com/pricing)(需要魔法)\
有需要请联系管理员
:::
...
::: tip 使用建议
该功能@bot或者喊人格名会触发，人格列表用`rg`指令看\
人格会对回答产生非常大的影响，强烈建议根据自己需要自设人格\
当发现bot一直在复读前面话题时可以用`rg reset 人格名`重置
:::
